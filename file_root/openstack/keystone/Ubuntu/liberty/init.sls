...
keystone_conf:
  ini.options_present:
    ...
    - sections:
        ...
        database:
          connection: "{{ openstack_parameters['database'] }}://{{ keystone['database']['username'] }}:{{ keystone['database']['password'] }}@{{ openstack_parameters['controller_ip'] }}/{{ keystone['database']['db_name'] }}"
        memcache:
